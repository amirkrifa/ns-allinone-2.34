...
\"\n\
checkout_executable TCLSH \"/home/amir/ns-allinone-2.34/bin/tclsh8.4\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/home/amir/ns-allinone-2.34/bin/tclsh8.4\n\
but it doesn't seem to be there anymore, so\\\n\
...
Agent/DTNAgent set epidemic_buffered_bundles 0\n\
Agent/DTNAgent set delivered_bundles 0\n\
Agent/DTNAgent set deleted_bundles 0\n\
Agent/DTNAgent set number_of_generated_packets 0\n\
Agent/DTNAgent set number_of_deleted_bundles_due_to_ret_failure 0\n\
Agent/DTNAgent set number_of_asked_bundles 0\n\
Agent/DTNAgent set number_recv_bundles 0\n\
Agent/DTNAgent set total_delay 0\n\
Agent/DTNAgent set is_message_here 0\n\
Agent/DTNAgent set is_delivered 0\n\
Agent/DTNAgent set is_visitor_here 0\n\
Agent/DTNAgent set stat_data_size 0\n\
Agent/DTNAgent set epidemic_control_data_size 0\n\
Agent/DTNAgent set data_size 0\n\
Agent/DTNAgent set avg_per_meeting_stat 0\n\
Agent/DTNAgent set current_number_of_nodes 0\n\
Agent/DTNAgent set estimated_number_of_nodes 0\n\
\n\
\n\
